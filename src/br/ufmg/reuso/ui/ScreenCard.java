...
public class ScreenCard extends JDialog {
	...
	/**
	 * Cria a janela que mostrar√° a carta.
	 * 
	 * @param carta
	...
	// =====================================================================================//
	/**
	 * @return JPanel com os bot√µes abaixo da carta
	 */
	...
	// =====================================================================================//
	/**
	 * @return ActionListener respons√°vel pelo controle dos bot√µes
	 */
			...
			public void run() {
				...
				System.out
						.println(createAndShowCard(
								new CartaEngenheiro(
										"ES30",
										"Doutor em CiÍncia da ComputaÁ„o e 10 anos de experiÍncia. Excelente relacionamento.",
				...
				System.out
						.println(createAndShowCard(
								new CartaPenalizacao(
										"ReplicaÁ„o de CÛdigo",
										"CD12",
										"O jogador perde 1 artefato de cÛdigo.",
										...
										1,
										"Mesa do jogador com bugs em artefatos de cÛdigo e de rastro.",
				...
				System.out.println(createAndShowCard(
								new CartaBonificacao(
										"Gerador de CÛdigo",
										"CCD3",
										"BenefÌcio Permanente: Use essa carta para adicionar, em cada rodada, Use essa carta para adicionar, em cada rodada, 1 Use essa carta para adicionar, em cada rodada, 1 Use essa carta para adicionar, em cada rodada, 1 Use essa carta para adicionar, em cada rodada, 1 Use essa carta para adicionar, em cada rodada, 1 Use essa carta para adicionar, em cada rodada, 1 1 artefato de cÛdigo branco para um engenheiro.",
